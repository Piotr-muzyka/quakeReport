...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> fetchEarthquakeData(String requestUrl) {
        ...
        Log.v(LOG_TAG, earthquakes.toString());
        return earthquakes;
    }
    ...
    private static Earthquake extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            if (featureArray.length() > 0) {
                ...
                Log.v(LOG_TAG, "mag : " + mag);
                Log.v(LOG_TAG, "place : " + place);
                Log.v(LOG_TAG, "time : " + timeInMilliseconds);
                // Create a new {@link Event} object
                return new Earthquake(mag, place, timeInMilliseconds);
            }
